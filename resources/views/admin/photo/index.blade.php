                ...
                <tbody>
                    ...
                    @foreach ($photos as $item)
                        <tr>
                            <td>{{ $no++ }}</td>
                            <td>
                                <img src="{{ asset('storage/photo/' . $item->image) }}" alt="" style="height: 150px;">
                            </td>
                            <td>{{ $item->judul }}</td>
                            <td>
                                ...
                                class="d-inline">
                                    @csrf
                                    <button type="submit" onclick="alert('apakah yakin dihapus?')" class="btn btn-danger btn-sm">Hapus</button>
                                </form>
                            </td>
                        </tr>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h1 class="modal-title fs-5" id="uploadModalLabel">Modal Edit</h1>
